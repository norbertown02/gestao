...
export default function DashboardFiltrado() {
  ...
  const chartHeight = typeof window !== 'undefined' && window.matchMedia('(max-width: 780px)').matches ? 220 : 390
